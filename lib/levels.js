...
export const BOARD_COURSES = {
  edexcel: ['gcse-foundation', 'gcse-higher', 'alevel-pure', 'alevel-stats-mechanics', 'further-maths'],
  ...
  caie: ['gcse-foundation', 'gcse-higher', 'alevel-pure', 'alevel-stats-mechanics', 'further-maths'],
...
// is shown in the UI, since that's CAIE's actual terminology - the underlying
// course key stays the same, this is a display-only label swap (see
// courseDisplayLabel below).
