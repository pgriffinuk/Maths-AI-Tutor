...
export function computeBadges(attempts) {
  ...
  // "Topic mastered": 3 flawless attempts in a row on the same course + topic
  // (most recent first) - a GCSE Foundation "Fractions" attempt shouldn't
  // count toward mastering "Fractions" on a different course.
  const byCourseTopic = {};
