  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: size === 'lg' ? 12 : 8 }}>
      <svg width={px} height={px} viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect x="2" y="26" width="11" height="12" rx="1.5" fill="var(--ink)" />
        <rect x="14.5" y="16" width="11" height="22" rx="1.5" fill="var(--ink)" />
        <rect x="27" y="4" width="11" height="34" rx="1.5" fill="var(--gold)" />
      </svg>
      {withWordmark && (
        <span style={{
